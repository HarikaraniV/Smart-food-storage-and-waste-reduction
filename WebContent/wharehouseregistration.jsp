		...
		<div id="header">
			...
			<div id="menubar">
				<ul id="menu">
					...
					<li><a href="wharehouseregistration.jsp">Warehouse Registration</a></li>
		...
		<div id="site_content">
			<div id="content">
				...
				<form action="VoidmainServlet" method="post" name="appform">
					...
					<input type="hidden" name="type" value="com.voidmain.pojo.Wharehouse">
					<input type="hidden" name="redirect" value="wharehouseregistration.jsp">
					...
					<div class="form_settings">
						...
						<p>
							<span>Available Machinery</span>
							<textarea class="contact" name="machinaryavilable"></textarea>
